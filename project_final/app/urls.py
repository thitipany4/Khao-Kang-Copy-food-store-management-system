...
urlpatterns = [
    ...
    path('create/',AddFoodView.as_view(), name='create'),
    # path('managefood/',managefood,name='managefood'),
    # path('managefood/<str:date>/',managefood,name='managefood_add'),
    path('managefood/',ManageFoodView.as_view(),name='managefood'),
    path('managefood/<str:date>/',ManageFoodView.as_view(),name='managefood_add'),
    ...
    path('review/<int:id>/', ReviewFoodView.as_view(), name='review'),
    ...
    path('profile//',ProfileView.as_view(), name='profile_null'),
    path('profile/<str:username>/',ProfileView.as_view(), name='profile'),
    # path('calendar/',calendar,name='calendar'),
    # path('calendar/<str:date>/<str:mark>/',calendar,name='calendar-date'),
    path('calendar/',CalendarView.as_view(),name='calendar'),
    path('calendar/<str:date>/<str:mark>/',CalendarView.as_view(),name='calendar-date'),
    # path('note/<str:date>/<str:type>/',note,name='note'),
    # path('note/<str:date>/<str:type>/<str:filter>/',note,name='note'),
    path('note/<str:date>/<str:type>/',AddTransactionView.as_view(),name='note'),
    path('note/<str:date>/<str:type>/<str:filter>/',AddTransactionView.as_view(),name='note'),
    ...
    path('checkout/<str:ref_code>/<str:total_price>/', CheckoutView.as_view(), name='checkout'), 

    path('order_confirm/<str:ref_code>/', UserConfirmOrderView.as_view(), name='order_confirm'),
    ...
    path('confirm_order/', AdminConfirmOrderView.as_view(), name='confirm_order'),
    path('confirm_order/<str:filter>/', AdminConfirmOrderView.as_view(),name='sort_confirm_order'),
    path('confirm_order/<str:code>/<str:status>/',  AdminConfirmOrderView.as_view(), name='confirm_order'), 
    ...
    path('history_order/', MyHistoryView.as_view(), name='my_history'),
    path('history_order/<str:filter>/', MyHistoryView.as_view(), name='my_history'),
